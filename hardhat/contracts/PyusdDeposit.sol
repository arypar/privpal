...
contract PyusdDeposit {
    ...
    /**
     * @notice Deposit PYUSD tokens into the contract
    ...
    function depositPyusd(uint256 amount) external {
        ...
        require(pyusdToken.allowance(msg.sender, address(this)) >= amount, "Insufficient allowance");
    ...
    function withdraw(
        ...
        require(pyusdToken.balanceOf(address(this)) >= amount, "Insufficient contract balance");
    ...
    /**
     * @notice Get contract's total PYUSD balance
     * @return Contract's PYUSD token balance
     */
